<?php if (!defined('THINK_PATH')) exit();?>    <div class="alert alert-info">当前位置<b class="tip"></b>团队管理<b class="tip"></b>成员管理
...
<?php for($i = 0 ; $i < count($members); $i++ ) { ?>        
            <tr class="tr_chairman">
                <td class="my_td td_odrer"><?php echo ($members[$i]["order"]); ?></td>
                <td><?php echo ($members[$i]["name"]); ?></td>
                <td><?php echo ($members[$i]["title"]); ?></td>
                <td><?php echo ($members[$i]["honor"]); ?></td>
                <td>
                	<a href="/Cms/<?php echo ($CURRETN_CONTROLLER); ?>/<?php echo ($CURRETN_MODULE); ?>/<?php echo ($members[$i][id]); ?>"><button class="btn btn-success edit" data-toggle="tooltip" title="编辑"><span class="glyphicon glyphicon-edit"></span></button></a>
                    <button class="btn btn-success up move" data-toggle="tooltip" title="上移" url-link ="/Cms/Common/move/team_member/up/<?php echo ($members[$i][id]); ?>"><span class="glyphicon glyphicon-arrow-up"></button>
                    <button class="btn btn-success down move" data-toggle="tooltip" title="下移" url-link ="/Cms/Common/move/team_member/down/<?php echo ($members[$i][id]); ?>"><span class="glyphicon glyphicon-arrow-down"></button>
                    <button class="btn btn-danger del" data-toggle="tooltip" title="删除" url-link ="/Cms/Common/delete/team_member/1/<?php echo ($members[$i][id]); ?>"><span class="glyphicon glyphicon-trash"></span></button>
                </td>
            </tr>
<?php } ?> 		
...
<?php if( $show_list == 0 ) { ?>
		...
		<div class="manager-avatar">
			<img class="img-avatar" src="<?php echo ($members[0]["img_url"]); ?>" alt="图片加载失败">
        </div>
		...
		<div class="col-md-5">
        	...
        	<div class="one-line">
        	    <div class="input-group">
        	        ...
        	        <input id = "c_name" type="text" class="form-control" aria-describedby="sizing-addon1" value="<?php echo ($members[0]["name"]); ?>">
        	    </div>
        	</div>
        	...
        	<div class="one-line">   
        	    <div class="input-group">
        	      ...
        	      <input id = "c_title" type="text" class="form-control" aria-describedby="sizing-addon1" value="<?php echo ($members[0]["title"]); ?>">
        	    </div>
        	</div>
            ...
            <div class="one-line">   
                <div class="input-group">
                  ...
                  <input id = "c_honor" type="text" class="form-control" aria-describedby="sizing-addon1" value="<?php echo ($members[0]["honor"]); ?>">
                </div>
            </div>
        ...
        <div class="col-md-12 one-line">                         
            <div class="input-group">
                ...
                <textarea id = "c_description" class="form-control" rows="8"><?php echo ($members[0]["description"]); ?></textarea>
            </div>     
        </div>
        ...
        <div class="col-md-5 col-md-offset-5 one-line">
            ...
            <a href="/Cms/<?php echo ($CURRETN_CONTROLLER); ?>/<?php echo ($CURRETN_MODULE); ?>/list"><button class="btn btn-success">返回</button></a>          
        </div>
