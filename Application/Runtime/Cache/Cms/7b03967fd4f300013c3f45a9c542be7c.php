<?php if (!defined('THINK_PATH')) exit();?><div class="alert alert-info">当前位置<b class="tip"></b>新闻中心<b class="tip"></b>图片新闻</div>
...
<?php for($i = 0; $i < count($data); $i ++) { ?>
            ...
            <tr class= "tr_chairman">
                ...
                <td>
                    ...
                    <a href="/Cms/News/tpxw?act=update&id=<?php echo ($data[$i]['id']); ?>"><button class="btn btn-success edit"><span class="glyphicon glyphicon-edit"></span></button></a>
...
<?php } ?>
            ...
            <tr>
                <td colspan="100">
                    <a href="/Cms/News/tpxw?act=add"><button class="btn btn-primary add"><span class="glyphicon glyphicon-plus"></span>添加</button></a>
                </td>
            </tr>
...
$("[delete]").on("click", function(){
    if(window.confirm("确定删除该文章?")) {
        ...
        $.post(window.location.pathname + "?act=delete", data, function(data) {
            window.location.href = "/Cms/News/tpxw";
        });
    }
});
</script>