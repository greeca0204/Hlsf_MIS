<?php if (!defined('THINK_PATH')) exit();?><div class="alert alert-info">当前位置<b class="tip"></b>新闻中心<b class="tip"></b>和灵咨询</div>
...
<?php for($i = 0; $i < count($data); $i ++) { ?>
            ...
            <tr class= "tr_chairman">
                ...
                <td>
                    ...
                    <a href="/Cms/News/hlzx?act=update&id=<?php echo ($data[$i]['id']); ?>"><button class="btn btn-success edit"><span class="glyphicon glyphicon-edit"></span></button></a>
