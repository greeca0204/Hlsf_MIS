<?php if (!defined('THINK_PATH')) exit();?>    <div class="alert alert-info">当前位置<b class="tip"></b>投资项目<b class="tip"></b>上市项目
...
<?php for($i = 0 ; $i < count($projects); $i++ ) { ?>        
            <tr class="tr_chairman">
                ...
                <td>
                    ...
                    <button class="btn btn-success up move" data-toggle="tooltip" title="上移" url-link ="/Cms/Common/move/project_ssxm/up/<?php echo ($projects[$i][id]); ?>"><span class="glyphicon glyphicon-arrow-up"></button>
                    <button class="btn btn-success down move" data-toggle="tooltip" title="下移" url-link ="/Cms/Common/move/project_ssxm/down/<?php echo ($projects[$i][id]); ?>"><span class="glyphicon glyphicon-arrow-down"></button>
                    <button class="btn btn-danger del" data-toggle="tooltip" title="删除" url-link ="/Cms/Common/delete/project_ssxm/1/<?php echo ($projects[$i][id]); ?>"><span class="glyphicon glyphicon-trash"></span></button>
                </td>
            </tr>
<?php } ?> 	
            <!-- <添加按钮> -->                        
