<?php if (!defined('THINK_PATH')) exit();?> 	<div class="alert alert-info">当前位置<b class="tip"></b>联系我们<b class="tip"></b>基本设置</div>

       <!-- <第1行> -->
        <div class="col-md-6 one-line">
            <div class="input-group">
                <span class="input-group-addon" id="sizing-addon1">地址</span>
                <input id = "address" type="text" class="form-control" aria-describedby="sizing-addon1" value="<?php echo ($company[0]["address"]); ?>" readonly="readonly">
            </div>
        </div>
        ...
        <div class="col-md-6 one-line">   
            <div class="input-group">
              ...
              <input id = "zipcode" type="text" class="form-control" aria-describedby="sizing-addon1" value="<?php echo ($company[0]["zipcode"]); ?>" readonly="readonly">
            </div>
        </div>
        ...
        <div class="col-md-6 one-line">
            <div class="input-group">
                ...
                <input id = "areacode" type="text" class="form-control" aria-describedby="sizing-addon1" value="<?php echo ($company[0]["areacode"]); ?>" readonly="readonly">
            </div>
        </div>
        ...
        <div class="col-md-6 one-line">   
            <div class="input-group">
              ...
              <input id = "phone" type="text" class="form-control" aria-describedby="sizing-addon1" value="<?php echo ($company[0]["phone"]); ?>" readonly="readonly">
            </div>
        </div>
        ...
        <div class="col-md-6 one-line">
            <div class="input-group">
                ...
                <input id = "fax" type="text" class="form-control" aria-describedby="sizing-addon1" value="<?php echo ($company[0]["fax"]); ?>" readonly="readonly">
            </div>
        </div>
        ...
        <div class="col-md-6 one-line">   
            <div class="input-group">
              ...
              <input id = "email" type="text" class="form-control" aria-describedby="sizing-addon1" value="<?php echo ($company[0]["email"]); ?>" readonly="readonly">
            </div>
        </div>
