<div class="alert alert-info">当前位置<b class="tip"></b>新闻中心<b class="tip"></b>图片新闻<b class="tip"></b>编辑</div>
...
<div class="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <textarea name="content" id="content" cols="80" rows="10">{$data.content}</textarea>
        </div>
    </div>
    <div class="form-group">
