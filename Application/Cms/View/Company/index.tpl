    ...
    <div class="alert alert-info">当前位置<b class="tip"></b>公司设置<b class="tip"></b>基本设置</div>
        ...
        <div class="col-md-6 one-line">
            <div class="input-group">
                ...
                <input id = "c_name" type="text" class="form-control" aria-describedby="sizing-addon1" value="{$company[0].name}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="col-md-6 one-line">   
            <div class="input-group">
              ...
              <input id = "c_address" type="text" class="form-control" aria-describedby="sizing-addon1" value="{$company[0].address}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="col-md-6 one-line">
            <div class="input-group">
                ...
                <input id = "c_slogan" type="text" class="form-control" aria-describedby="sizing-addon1" value="{$company[0].slogan}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="col-md-6 one-line">   
            <div class="input-group">
              ...
              <input id = "c_icp" type="text" class="form-control" aria-describedby="sizing-addon1" value="{$company[0].icp}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="col-md-12 one-line">                         
            <div class="input-group">
                ...
                <textarea id = "c_description" class="form-control" rows="3" readonly="readonly">{$company[0].description}</textarea>            
            </div>
        </div>
        ...
        <div class="col-md-12 one-line">                         
            <div class="input-group">
                ...
                <textarea id = "c_introduction" class="form-control" rows="8" readonly="readonly">{$company[0].introduction}</textarea>
            </div>     
        </div>
