  ...
  <div class="alert alert-info">当前位置<b class="tip"></b>公司设置<b class="tip"></b>图片设置</div>
	...
	<div class="col-md-12 img-area">
		...
		<div class = "div-s">
			<img class="img-logo img-s one-line" data-toggle="tooltip" title="logo" src="{$company[0].logo}" alt="「Logo」加载失败">
			<img class="img-qrcode img-s one-line" data-toggle="tooltip" title="二维码" src="{$company[0].qrcode}" alt="「二维码」加载失败">
			<img class="img-partner img-m one-line" data-toggle="tooltip" title="合作伙伴图" src="{$company[0].partner}" alt="「合作伙伴图」加载失败">
		</div>

		<div class = "div-l">
			<img class="img-frame img-l one-line" data-toggle="tooltip" title="组织结构图" src="{$company[0].frame}" alt="「组织结构图」加载失败">
